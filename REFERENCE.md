# Velterra Campaign Reference

A comprehensive index of characters, locations, items, factions, lore, and episode summaries for the Velterra D&D campaign book. This document exists so that AI assistants can quickly locate relevant content without re-reading all episode files each session.

**Usage**: Search this file by keyword to find what you need, then read the linked source file for full detail. Episode files are sacred and must never be edited.
...
2. [Secondary Characters](#secondary-characters)
3. [Factions & Groups](#factions--groups)
4. [Locations](#locations)
5. [Items & Gear](#items--gear)
6. [The Seven Gods](#the-seven-gods)
7. [Key Lore & Terminology](#key-lore--terminology)
8. [Episode Index](#episode-index)
...
- **Player**: Stephen Harland (character 1 of 4)
- **Race/Class**: Human Book Burner | **Age**: 46 | **Status**: Deceased
- **Source**: `content/chars/pilcheur.tex`
- **Episodes**: 1-24 (dies at sea), 33-5a to 33-5d (Book Burner flashbacks)
- **Summary**: Cloaked Book Burner. Cowardly but occasionally brilliant. Possessed by dark forces, manifested shadow powers (darkness clouds, shadow wolf Howlov, sentient shadow sword Black Sabbath/Iron Maiden). Was secretly selling books instead of burning them, contributing to Book Burner purge. Had familiar Quoth the Raven. Bore the Mark of Synne. Various aliases including Papa Lazarizz.
- **Key moments**: Possession and exorcism in Riverfall (ep 5-6), shadow powers, Dies Hard heist (ep 7-9a), death at sea (ep 24), Book Burner flashback reveals his betrayal caused the purge (ep 33-5c)

### Lady Otoria Hearthrust
- **Player**: Joshua Rodell (character 1 of 3)
- **Race/Class**: Robot Fighter | **Age**: 80 | **Status**: Deceased
- **Source**: `content/chars/otoria.tex`
- **Episodes**: 1-9a (dies ep 9a)
- **Summary**: Mysterious swordswoman from Nanduan. Actually a dwarven-crafted automaton (robot with a soul). Fiercest warrior and most principled member. Zero tolerance for cruelty. Part of the Hearthrust Dynasty. Had killed the Emperor of Masuda and founded the Hearthrust Society (robot lady emancipation movement) before coming to Velterra. Betrothed to unnamed shipping magnate. Died at blade of Lark during Die Hard heist. Her legacy lives on through Lady Hirota Hearthrust who rescues the party with a mechanical eagle in Masuda (ep 44).
- **Key moments**: Fighting at Temple of Unthala (ep 1-3), pinning Pilch to wall for murdering prisoner, death at Tower of Imota Kan (ep 9a), revealed as robot post-mortem, legacy through Hearthrust Society

### Gary
- **Player**: Joshua Rodell (character 2 of 3)
- **Race/Class**: Stone Man / Police | **Age**: 8,000,000 | **Status**: Sleeping (regenerating)
- **Source**: `content/chars/gary.tex`
- **Episodes**: ~10-26 (awakened after Otoria's death, sacrifices self in jungle)
- **Summary**: Ancient stone elemental awakened by eating a magical biscuit. Moral heart of the group. Pacifist who fought only when necessary. Wielded a flowering branch (rainbow/glitter attacks). Joined Hope's Rest police as Officer Djago. Drew three-panel "Triplicate" comics. Oxygen addiction, brief Gabrin Kokaine dependency. Founded Gary Guild through impassioned speech. Sacrificed himself protecting Kolo, transformed into tree. Will regenerate in several hundred years. Airship and guild named after him.
- **Key moments**: Awakening (ep ~10), impassioned guild speech (ep 13-14), police work (eps 15-18), sacrifice in jungle (ep 26)

### Mark O'Synne
- **Player**: Stephen Harland (character 2 of 4)
- **Race/Class**: God / Luck Man | **Age**: 800,000 | **Status**: Active (unfortunately)
- **Source**: `content/chars/mark.tex`
- **Episodes**: ~24 onwards (emerged from Gary's chest on jungle continent)
- **Summary**: Avatar/fragment of the god Synne. Previously bound to Pilch's forearm as "Mark of Synne". Golden-haired small figure. Universally disliked ("dickhead"). Creates copies of himself (Lark, Jark, Sark, Shark). Provides luck-bending abilities. Trapped in Burnie's arm. Working to prevent/reverse the Sundering.
- **Key moments**: Emerging from Gary (ep ~24), Hell management training, trapped in Burnie's arm, creating the time-travel VR machine (ep 33-5a framework)

### Vu Dong / Jeremy / Jezza
- **Player**: Stephen Harland (character 3 of 4)
- **Race/Class**: Monkey companion | **Status**: Erased from timeline
- **Source**: `content/chars/miscCharacters.tex`
- **Episodes**: ~27-34
- **Summary**: Magical monkey who wielded staves and Pilch's old sword. Navigated by tail-stick when blinded. Suffered from "butterfly effect" during Book Burner flashback and stopped existing in the timeline (ep 33-5d).
...
- **Race/Class**: DesertCat Barbarian | **Age**: 42 | **Status**: Departed (heading to the Expanse)
- **Source**: `content/chars/toni.tex`
- **Episodes**: 55-66
- **Summary**: Large tiger-man sent from Guild of Coin to negotiate with Riphard about the bank. Carries briefcase and unnecessary cane. Has berserker rage ability. Joined party after Riphard was destoned (ep 56). Led trade negotiations with merfolk at New Abbergast (ep 60). Disgusted by magical ensorcellment at Golding's Bay temple that made party slaughter villagers (ep 63). Surrendered to arbiters in protest (ep 64), rescued by Burnie. Left the group heading to the Expanse (ep 66), with assassin contract issued against him if he returns.
- **Key moments**: Arrival by stagecoach (ep 55), berserker rage saving Burnie (ep 55), meets Lazarus in Hell (ep 58), leads merfolk trade deal (ep 60), surrenders to arbiters (ep 64), departs (ep 66)
...
- **Note**: Stephen Reddish played Kolo Kozolski initially, then Toni, then Martin.
...
| **Julieto** | Emperor's daughter | Thrown out of window by Myron during rescue mission. |
| **Grumpy Stanri** | Goblin emancipator (legend) | Hero of Kolo's Tale (eps 9b-9d). Elder goblin cleric. Necromancer, philosopher, had gout. |
...
| Character | Role |
|-----------|------|
| **Sandi** | Book Burner recruit. Powerful grappler. Became professional wrestler following idol Derek Bodacious. |
| **Mr Motivator** | Book Burner recruit. Incredibly fast. Motivational fighter. Became political pawn of assassin's guild. |
| **Bones** | Book Burner recruit. Scalpel-wielding creep. Betrayed team to stay with Frankenfur. Has crab-man friend. |
| **Martha** | Book Burner cook. Frying pan fighter. Dies in friendly fire trying to save Burnie (ep 33-5c). |
| **Book Burner Tyrone/Treyvon** | Old Tengu. Bird person. Two days from retirement. Dies to Arbiter (ep 33-5c). |
| **Frankenfur/The Mistress** | Mad scientist creating crab-people. Bones stayed with her. |
| **Chris Mas** | Large, swole guard at Jennies Ball. Leader figure of the Chris guild (ep 33-5d). |
| **Amelia Bobacious** | Derek's daughter. Ran the Chris guild. "Total bitch". |

---

## Factions & Groups

Source: `content/story/groups.tex`

| Faction | Description | Key NPCs | Episodes |
|---------|-------------|----------|----------|
| **Church of the Seven** | Dominant political/spiritual power. Uses filtered god-power to rule. Created the Sundering. Hierarchy: Pastors → Arbiters → Inquisition. Framed party as "Cult of Synne" (ep 65). 8000 troops sent to Hope's Rest for final battle (ep 78). | Kiros, Khan, Marshall of Logarsk | Throughout |
| **The Inquisition** | Church's elite secret enforcement. Dark masked figures with tentacle maws instead of mouths. Canilon tattoo under chest. Immune to all non-Excalibrum weapons (ep 67). Inquisitor Ravagers have metal spikes for hands (ep 80). | Various | eps 12, 67, 80 |
| **The Jennies** | Criminal organisation of courtesans. Led by Mae Harkwood from "Whorecity". Originally courtesans, went underground when Church outlawed their profession. | Mae Harkwood, Delilah | eps 4-6, 12+ |
| **SRA (Small Rights Activists)** | Gnome/halfling terrorist group. Led by Razzle Backshine. Exploding things. Freyer Thistlebloom runs Golding's Bay branch with magic (ep 63). | Razzle, Buttons, Freyer | eps 10-12, 63 |
| **Book Burners** | Church's literary enforcers (defunct). Hunted/destroyed heretical texts. Purged when members (like Pilch) were caught selling books. HQ became Gary Guild base. | Pilcheur, Burnie, Lillian, Zippy, Archibald, Trayvon | eps 1-24, 33-5a to 33-5d |
| **Gary Guild** | "Garys Against Religion, Yo". Founded by party in Hope's Rest. Front for anti-Church operations. Won guild council vote. Taken over by Garbigail while party was away (ep 50). Joins alliance army for final battle (ep 79). | Gary, Derek Bobacious, Garbigail | eps 13-15+ |
| **The Bank / Guild of Banking** | First financial institution in Velterra. Founded by Riphard. Started in Derek's house (Riverfall). "Safe Storage for a Dangerous World". Thriving during party's absence (ep 50). | Riphard, Derek, Rowlett Marnett | eps 5-6, 13+ |
| **Hearthrust Society** | Robot lady emancipation movement from Nanduan. Founded by Otoria. Allied with party in Masuda. Lady Hirota rescues party with mechanical eagle (ep 44). Female ninja riders on mechanical eagles at Seven's Spire (ep 80). | Lady Vashen, Lady Hirota, Lady Averio | Masuda arc, ep 44, 80 |
| **Hell Inc.** | Bureaucratic afterlife dimension. Devils do bookkeeping, demons do torturing. Overwhelmed by Church's sin definitions. | Lazarus, Arbigal, Meredith | Throughout |
| **The Varg** | Northern warlord/barbarian alliance. Enslaved goblins. Bearkin warriors. Roving bands across snowy northern territory. Children watch travellers from hills (ep 72). Varg Hold is massive tent city (ep 72). | Hunthar Varg (historical) | Background, eps 71-73 |
| **Thieves Guild** | Operating in Hope's Rest under Guild of Services. "Wealth engineers". Kevin has contacts (ep 70). | Various | eps 10-15, 70 |
| **Assassins Guild / University of Assassins** | Operating in Hope's Rest. Burnie was former teacher. Buck McCraw trains students. Kevin is PhD student. Clockwork ninja assassins join alliance army (ep 79). | Buck McCraw, Kevin | eps 33-5b-c, 69+ |
...
Sources: `content/world/vel.tex`, `content/world/locations.tex`

### Main Land (Church-controlled)

| Location | Description | Key Events | Episodes |
|----------|-------------|------------|----------|
| **Hope's Rest** | Largest city in Velterra. Guild-run (5 families: Life, Might, Coin, Service, Making). River Eldon runs through. GEO: Parchet Green. | Gary Guild founding, bank establishment, Book Burner HQ acquisition, guild politics, SRA encounter, Kolo's sewer lair, Inquisitor fight, Delilah's birth/death | 10-20, 33-5a to 33-5d, 50, 58, 66-69 |
| **Book Burner HQ** | Former BB headquarters in Hope's Rest. Now Gary Guild base. Firepoles between floors, vault in basement, 3rd floor workshop (Exme's), library (Archibald). | Party HQ, Exme's workshop | 13+ |
| **Vathos Boundary** | Small settlement at edge of civilised world. Pubs: Copper Flagon, "Titty bar". Countryside: Dutty Hoes Camp, RWA cave, Forest of Big Pig. | Starting area, Temple of Unthala nearby | 1-3 |
| **Temple of Unthala** | Skull-shaped ice temple south of Vathos Boundary. Home to TikkiTukks. Contains Stone of Unthala. Dart traps, masked bear-creatures, giant spider. | Retrieving Stone of Unthala | 1-3 |
| **Riverfall** | Fair-sized town with rivers/waterfalls. 4 pubs. Sanctuary of Novetta. Tower of Imota Kan. Derek Bobacious's house (first bank). | Bank founding, Pilch exorcism, Die Hard heist | 4-9a |
| **Tower of Imota Kan** | Nakatomi backwards. Secure facility in Riverfall with vault, library, sacred ruby sphere. Managed by Holly. | Die Hard heist (Hans), Otoria's death (Lark) | 7-9a |
| **Seven's Spire** | City with massive Church spire. Source of the seal keeping gods out. Festival of Light celebration. Tower layout: Floor 1 stores/servants/guards, Floor 2 guards, Floor 3 officers, Floor 4+ clergy/books/prison/pinnacle. Massive sewer network. | Resupply stop (~ep 10), final assault (eps 78-80) | ~10, 78-80 |
| **Logarsk** | Sleepy town with coming-of-age trial for 5-year-olds. Church basement contains Inthun slab. Spanish Inquisition encounter. Airship returned here for Stonecast Mech (ep 78). | Discovering Inthun, Kiros encounter, saving boy from ceremony | ~11-12, 78 |
| **The Great Expanse** | Desert. Spancers (anti-Church bandits/allies). People get lost. | Desert crossing, alliance with Spancers/Tengu | ~19-20 |
| **Port Averdale** | Major port. Colourful people, shady dealings. Square made of two triangles. | Departure for South Africa | ~20-22 |
| **Tom'ardy Mountains** | Dwarven homeland. Exclusive/reclusive high-status families. Each dynasty in own mountain. Slave economy (Delvers). Now a socialist utopia and party are heroes (ep 76). | Riphard's family, search for Excalibrum, finding Lillith and Targon, performing the greatest play ever played | 51-55, 76 |
| **Golding's Bay** | Town controlled by Freyer Thistlebloom (SRA). Party ensorcelled into slaughtering villagers in temple. Written as spy report. | Ensorcellment massacre | 63 |
| **Linderdorf** | Mountain city built into mountain. Dense warren of foundries, mills, shops. Automatons throughout — lithe models in shops, hulking guards. University (Prof. Jorge Myron). Bastion of civilisation against the Varg. Ships weapons and steel across Velterra. Clawtech arena. Google Von Maccherstein's workshop. | Hunt for blacksmith, Myron family reunion, arena robot fight, Excalibrum weapons forged, alliance army mustered | 70-76, 78 |
| **New Abbergast** | Island settlement. Lady Gharbighast rules. Thriving after party's trade deal. Church sent envoys trying to turn them against party. | Merfolk alliance, Acroneth killed, fish army recruited, monster ruins battle | 60-62, 77 |
| **Clawtech Arena** | Battle arena in Linderdorf. Party fought 30ft Stonecast Mech and won. | Arena fight for giant robot | 75 |

### Other Continents & Regions

| Location | Description | Key Events | Episodes |
|----------|-------------|------------|----------|
| **Nanduan** | Large NE coastal kingdom on Erassa. Maritime trade. Hearthrust Dynasty. Limited Church contact. Sand Daggers, Balloon Cows. | Otoria's homeland, Hearthrust Society origin | Background |
| **Masuda** | Southern kingdom, strained relations with Nanduan. Samurai culture. Civil war. | Civil war arc, becoming Ronin, Lord of Lightning, Golden Hall, Hammer of the Gods, Orcano fight, Hearthrust rescue | ~30-48 |
| **South Africa (Jungle Continent)** | Caribbean-like port (Akultheok). Dangerous jungles. Cannibal TikkiTukks. Tower of Ruh'Breks hidden here. | Pilch's death, Gary's sacrifice, finding Tower and airship, Puzzle Die | 22-27 |
| **Akultheok** | Main port on South Africa. Caribbean beach resort vibes, great cocktails. | Arrival on jungle continent | ~22-23 |
| **Tower of Ruh'Breks** | Ancient wizard's hidden underground stronghold in jungles. Contains airship and Puzzle Die. | Discovering airship and Die, meeting Ruh'Breks Sensei | ~25-27 |
| **Hell** | Afterlife dimension. Hot. Lazarus's office/war room accessible via dreams. Kevin fell out the window for eternity (ep 69). | Party resurrections, communications with Lazarus, war planning | Throughout |
| **Varg Lands** | Snowy northern territory beyond Linderdorf. Roving bands of goblins, ogres, bearkin. Varg Hold is a massive tent city stretching miles. Bitter cold, snowstorms. Giants roam near the mountains. | Hunt for Google, finding Martin, Bright Bart Forge | 71-73 |
| **Bright Bart Forge** | Ancient dwarven forge at mountain summit in Varg territory. Sealed by Aspect of the Storm (air elemental guardian). Source of legendary weapons. Full of dwarven skeletons (sealed themselves in when mountain was possessed). Books on rune carving and forging found here. | Discovered and cleared, forging knowledge retrieved | 73 |
...
Sources: `content/gear/misc.tex`, `content/gear/weapons.tex`, `content/gear/theGary.tex`, `content/gear/STANRI.tex`

| Item | Type | Description | Location |
|------|------|-------------|----------|
| **Stone of Unthala** | Artefact | Size of two fists. Allows communication with Lazarus. May enhance nearby powers. Retrieved from Temple of Unthala. | `content/gear/misc.tex` |
| **Die/Cube of Ruh'Brex** | Artefact | Magical puzzle cube with dozens of functions. Semi-sentient. Can locate other artefacts and the source of the seal (Seven's Spire, ep 75). Functions include: Lockdown, Locate Artefact, Invisibility, Summon TEST Goat, Fly, Motivator, Teleport, Portable Domicile, Minor Time Stop, Travel Speed, Healing, Summon Monster, Globe of Invulnerability, Wish (10,000yr cooldown), Korg the Earth Elemental (ep 73). Can plug into airship ghost engine for hyper-speed (ep 76). Has Apprentice Security Mode (idiot-proof lockdown, ep 69). Interplanar pocket dimension with door (ep 80). | `content/gear/misc.tex` |
| **Slab of Inthun** | Artefact | Enchanted stone slab. Grants immense power (strength, magic, invulnerability) OR kills the user. Works better on children. Found in Logarsk church basement. | `content/gear/misc.tex` |
| **Excalibrum / Starmetal** | Material | Rare divine metal from meteorites. Can harm Inthun-blessed beings and Inquisitors (only thing that works on them, ep 67). Found in Tom'ardy mines (ep 57). Forged into weapons by Google's team using Bright Bart Forge knowledge (ep 73-74). | `content/gear/misc.tex` |
| **The Burner** | Tool | Original Book Burner lighter. Produces flame, imbues weapons with fire (1/day), reveals intentionally misleading text. Ancient Velterran inscription. | `content/gear/misc.tex` |
...
| **Excalibrum Pickaxe** | Pick | Found in Tom'ardy mines (ep 57). Used to kill the Inquisitor (ep 67). Myron smashed the Bright Bart Forge lock with it (ep 73). | Episodes |
...
Source: `content/story/theGods.tex`

| God | Title | Domain |
|-----|-------|--------|
| **Lathor** | The Mother and Father, The Horizon | Goodness, Faith, Leadership, Family. First among equals. |
| **Elledun** | The Lantern-Bearer, The Rising Sun | Hope, Light, Agriculture, Travellers. Roadside shrines with candles. |
| **Belladon** | The Open-Handed, The Crystal Spring | Charity, Forgiveness, The Home. |
| **Hemotate** | The Book-Bearer, The Tree in the Storm | Justice, Fairness, Karma, Scholarly Pursuits. |
...
## Key Lore & Terminology

| Term | Meaning |
|------|---------|
| **Gabrins** | Goblins (in-world term used by players) |
| **CC** | Church Calendar (campaign year is 6653 CC) |
| **The Sundering** | Event where Church used Great Stone to sever world from gods. Intended as protection, became a prison. |
| **Great Stone / Stone of the Eight** | Artefact used to create the Sundering. Located at Seven's Spire. Originally called "Stone of the Eight" (acknowledging Synne). |
| **Excalibrum / Starmetal** | Rare divine metal from meteorites. Only material that can harm Inquisitors. |
| **The Inthun** | Enchanted stone slab granting immense power at great risk. Works better on children. |
| **Varg** | Northern warlord/barbarian alliance. Enslaved goblins. Bearkin warriors. |
| **Arbiters** | Church warrior-enforcers. Plate-armoured, gun-carrying. |
| **The Inquisition** | Church's elite secret enforcement arm. Immune to non-Excalibrum weapons. Tentacle maws. Canilon tattoos. |
| **Book Burners** | Church's literary enforcers (now defunct). Hunted heretical texts. |
| **Emancipation** | Central theme of goblin culture. Freedom from human/Church oppression. Martin's rallying cry at arena (ep 75). |
| **Spancers** | Anti-Church group in the Great Expanse (desert bandits/allies). |
| **TikkiTukks / Tiki Tuks** | Small bear-like creatures with masks and sharp teeth. Some cannibalistic. |
| **Gabrin Kokaine** | Substance Gary briefly became addicted to. |
| **Killepitsch** | Liquor used in Pilch's exorcism. |
| **Balloon Cow** | Like cows, but inflatable. Found in Nanduan. |
| **Sand Dagger** | Dangerous sneaky creatures in Nanduan. |
| **Delvers** | Dwarven miners sent on one-way trips into the deep. Slave class in Tom'ardy Mountains. |
| **The Petite Ferret** | Pub in Hope's Rest. Run by Horatio BrambleThrust. |
| **Bertrands Stand** | Last defensive wall in Hope's Rest. |
| **Northern Rock** | Riphard's first bank, in Derek's house in Riverfall. |
| **Piece of Shit** | Myron's cocktail: one part sherry, one part grenadine, one part Bovril. Named after Riphard (ep 70). |
| **Craftwerk** | Construct/automaton — term used for Martin and similar beings in Linderdorf. |
| **Festival of Light** | Church celebration of all gods. Pilgrimage to Seven's Spire. Used as cover for party's infiltration (ep 78). Masked festival. |
| **Cult of Synne** | Church's label for the party (ep 65). Used to frame them as criminals. |
| **Salumist** | Someone from Linderdorf. Sausages are "a type of face" (ep 70). |

---

## Episode Index

### Main Campaign (eps 1-9a)

| Ep | Title | Summary | File |
|----|-------|---------|------|
| 1 | Resurrection & the Stone | Party resurrected by Lazarus in Hell. Given mission to destroy Church. Travel south to retrieve Stone of Unthala from ice temple. Fight TikkiTukks, giant spider, dart traps. | `content/eps/1.tex` |
| 2 | The Stone of Unthala | Continue through Temple of Unthala. Fight masked bear creatures. Retrieve Stone from chief's quarters. Kolo speaks TikkiTukk. Otoria establishes moral authority. | `content/eps/2.tex` |
| 3 | Return to Vathos | Return from temple. Encounters at Vathos Boundary. Party dynamics established. | `content/eps/3.tex` |
| 4 | Journey North | Travel toward Riverfall. Encounter Jennies. Delilah joins. Diego Escabar's Fancy Men hunted. | `content/eps/4.tex` |
| 5 | Riverfall | Arrive in Riverfall. Visit pubs. Pilch's possession worsens. Riphard discovers Sanctuary of Novetta. Begin bank idea. | `content/eps/5.tex` |
| 6 | The Exorcism | Pilch exorcised using pastoral chanting, Killepitsch liquor, and vomiting. Shadow sword Black Sabbath manifests. Bank "Northern Rock" established. | `content/eps/6.tex` |
| 7 | Die Hard (Part 1) | Hans and mercenaries seize Tower of Imota Kan. Party infiltrates. Holly taken hostage. | `content/eps/7.tex` |
| 8 | Die Hard (Part 2) | Continue tower assault. Pilch's shadow wolf Howlov. Fights across multiple floors. | `content/eps/8.tex` |
| 9a | Die Hard (Part 3) / Death of Otoria | Climax of tower heist. Otoria killed by Lark's katana. Party mourns. Exme discovers Otoria was a robot. Campfire send-off. Kolo begins telling a story. | `content/eps/9a.tex` |

### Kolo's Tale (eps 9b-9d)

Interlude episodes told by Kolo around the campfire after Otoria's death. The story of legendary goblin emancipator Grumpy Stanri.

| Ep | Title | Summary | File |
|----|-------|---------|------|
| 9b | The Greasy Rage of Clan Stanri | Stanri assembles gabrin crack team. Head to human town for a boat. Tan'lata murders guards. Devvy has greasy weasel. Kill dwarf pirates. Steal sailing ship. | `content/eps/9b.tex` |
| 9c | Snakes on a Boat | Sailing adventure. Captain betrays them. Giant sea snakes and tree octopus attack. Grumpy raises undead snake. Boat explodes. Death hippo encounter. Arrive at ruined goblin city. | `content/eps/9c.tex` |
| 9d | Kiss Myasis | Arrive in ruined Thundertree. Church of Hemotate destroyed the town. Human woman caring for goblin orphans. Stanri tries to inspire children with emancipation but fails. Must cross desert. | `content/eps/9d.tex` |

### Main Campaign (eps 10-55)

| Ep | Title | Summary | File |
|----|-------|---------|------|
| 10 | On the Road | Travel towards Hope's Rest. Encounter the SRA. Investigate gnome/halfling terrorist activities. | `content/eps/10.tex` |
| 11 | SRA Infiltration | Infiltrate Razzle Backshine's hideout. Kill Razzle, install Buttons as new leader. | `content/eps/11.tex` |
| 12 | Logarsk | Arrive in Logarsk. Church basement contains Inthun slab being used on children. First encounter with Inquisition. Meet Arbiter Kiros. | `content/eps/12.tex` |
| 13 | Hope's Rest (Part 1) | Arrive in the biggest city. Gary gives impassioned speech to guild council. Win vote to establish Gary Guild. | `content/eps/13.tex` |
| 14 | Hope's Rest (Part 2) | Set up Gary Guild in old Book Burner HQ. Meet Archibald. Exme claims 3rd floor workshop. Guild of Banking pitch. | `content/eps/14.tex` |
| 15 | Gary Joins the Police | Gary becomes Officer Djago. Bank operations begin. Derek Bobacious arrives for marketing. | `content/eps/15.tex` |
| 16 | The Bake Sale | Gary eats all the pies. Lemon theft scandal. Gabrin Kokaine incident. | `content/eps/16.tex` |
| 17 | Guild Operations | Day-to-day guild business. Gary's oxygen addiction. Pilch selling books secretly. | `content/eps/17.tex` |
| 18 | Political Manoeuvring | Guild politics intensify. Preparing to leave Hope's Rest. | `content/eps/18.tex` |
| 19 | The Great Expanse | Cross the desert. Meet Spancers/Tengu. Alliance formed. | `content/eps/19.tex` |
| 20 | Desert Crossing | Continue through Great Expanse. Approach the coast. | `content/eps/20.tex` |
| 21 | Port Averdale | Arrive at major port. Circus troupe failure. Prepare for sea voyage. | `content/eps/21.tex` |
| 22 | Setting Sail | Depart for jungle continent. Sea voyage begins. | `content/eps/22.tex` |
| 23 | At Sea | Sea voyage continues. Storm and creature encounters. | `content/eps/23.tex` |
| 24 | Death at Sea / Pilch Dies | Pilcheur killed by sea creature. Mark O'Synne emerges from Gary's chest. | `content/eps/24.tex` |
| 25 | Jungle Continent | Arrive in South Africa. Akultheok port. Enter dangerous jungles. | `content/eps/25.tex` |
| 26 | Gary's Sacrifice | Gary sacrifices himself protecting Kolo. Transforms into tree. | `content/eps/26.tex` |
| 27 | Tower of Ruh'Breks | Discover ancient wizard's hidden tower. Meet Ruh'Breks Sensei. Receive Puzzle Die and discover airship. Myron arrives (hot air balloon). Vu Dong joins. | `content/eps/27.tex` |
| 28 | The Airship | Claim airship "The Gary". Captain Stick commanding. Die of Ruh'Brex explored. | `content/eps/28.tex` |
| 29 | Airship Adventures | Flying in The Gary. Travel toward Masuda. | `content/eps/29.tex` |
| 30 | Arrival in Masuda | Meet Daisuke (interpreter). Discover civil war. Samurai culture. | `content/eps/30.tex` |
| 31 | Masuda Politics | Navigate Masudan politics. Become involved in civil war. | `content/eps/31.tex` |
| 32 | Lord of Lightning | Hunt electric beast. Myron slides underneath it. Shocking Gloves crafted. | `content/eps/32.tex` |
| 33 | Becoming Ronin | Party becomes Ronin in Masuda. Fighting alongside Lady Imicho. | `content/eps/33.tex` |

### Book Burner Flashbacks (eps 33-5a to 33-5d)

Framed as VR time-travel via Mark's magic storm machine on the airship. Party inhabits Book Burner recruits in the past.

| Ep | Title | Summary | File |
|----|-------|---------|------|
| 33-5a | Quantum Bookburners Creed: Special Child Meat Edition | New Book Burner recruits (Sandi, Mr Motivator, Bones, Martha). First assignment: find illegal printing press. Brainwashing newspapers turning people into zombies. | `content/eps/33-5a.tex` |
| 33-5b | Huey Shitpirate and the News | Sewer adventure. Fight "shit pirate" with domination powers. Find "How to Make Fiends and Influence People" book. | `content/eps/33-5b.tex` |
| 33-5c | Two Days from Retirement | Cult of Annihilators. Crab-people tunnels. Bones betrays team. Pilch found imprisoned — exposed as selling books, purge ordered. Treyvon dies. Martha dies. | `content/eps/33-5c.tex` |
| 33-5d | Bobacious Takes On Chrismas | Gary Guild B-team vs Chris Guild. Destroy toy factory. Amelia Bobacious behind debt contracts. **Real-world aftermath**: Vu Dong erased from timeline. Burnie arrives by boat. | `content/eps/33-5d.tex` |

### Main Campaign (eps 34-55)

| Ep | Title | Summary | File |
|----|-------|---------|------|
| 34 | Castle Infiltration | Rescue Romjiro. Myron throws Julieto out window, dies, revived. Major castle battle. | `content/eps/34.tex` |
| 35 | Masuda War | Continue civil war. Hearthrust Society allies with party. | `content/eps/35.tex` |
| 36 | Golden Hall | Approach the Golden Hall. Seeking Hammer of the Gods. Major military operation. | `content/eps/36.tex` |
| 37 | The Hammer | Retrieve Hammer of the Gods from Golden Hall. Riphard claims it. | `content/eps/37.tex` |
| 38 | Myron's Diary | Written as Myron's barely-literate diary. Worg/orc cave fight. STANRI Mk0 destroyed. Ping pong bonding with Riphard. | `content/eps/38.tex` |
| 39 | Battle with Inquisitor | Major confrontation with Church Inquisitor in Masuda. Ruh'Breks Sensei dies protecting the airship — holds back mountain creature. "You must get back to Velterra." | `content/eps/39.tex` |
| 40 | Post-Orc Genocide | Aftermath of orc battle. Goblin cocoon metamorphosis — party "become Ronin". Cube functions discovered. Battlefield corpses. | `content/eps/40.tex` |
| 41 | Departure from Masuda | Leave Masuda after civil war. Losses mourned. Journey back toward Velterra. | `content/eps/41.tex` |
| 42 | Myron's Diary 2 | Myron diary. Castle infiltration planning. Kolo disguises as Myron (prank). Puzzle die mishaps — Kolo flies instead of going invisible. | `content/eps/42.tex` |
| 43 | Return Journey | Flying back. Planning next moves. Puzzle Die guides toward Excalibrum. | `content/eps/43.tex` |
| 44 | Castle Escape | Castle escape. Orcano fight. Lady Hirota Hearthrust rescues party with mechanical eagle. Burnie disguises as dead Lord. | `content/eps/44.tex` |
| 45 | Approaching Tom'ardy | Nearing the dwarven mountains. Riphard's homeland. Discovering the class system. | `content/eps/45.tex` |
| 46 | Konrad the Robot Maker | Visit Konrad (~50 robots). Hearthrust Society negotiations. Learn about Kalimar from Lazarus. Burnie's orc funeral stew. | `content/eps/46.tex` |
| 47 | Tom'ardy Mountains | Enter dwarven territory. Exclusive/reclusive dynasties. Slave economy revealed (Delvers). | `content/eps/47.tex` |
| 48 | Battle of Masuda | Airship assault. Mountain lizard IS the mountains. Hammer of the Gods retrieved (it's a gun). Church wardens with "Cannillon demands their heads." | `content/eps/48.tex` |
| 48.5 | Half-Episode | Transitional episode. Exploring dwarven settlements. Meeting Riphard's extended family. | `content/eps/48-5.tex` |
| 49 | The Mines | Enter deep mines seeking Excalibrum. Meet Delvers. Find uncle Targon with arrow in belly. Find Lillith in a barrel. | `content/eps/49.tex` |
| 50 | Return to Hope's Rest | Gary Guild taken over by Garbigail. Bank thriving. Shoe sponsorship (Ralph Businessman). Meet Kiros — Excalibrum in Tom'ardy. Archibald/Daisuke romance epilogue. | `content/eps/50.tex` |
| 51 | Deeper Underground | Continue mine exploration. Ancient dwarven architecture. Rune-scribed archways. Encounter troglodytes. | `content/eps/51.tex` |
| 52 | Multiple Diaries | Multiple diary format. Enter Tom'ardy mines. Delver camps. Find uncle Targon. Hardstone vault. Leg surgery with tube. Comic epilogue. | `content/eps/52.tex` |
| 53 | Vaulted Feelings | Hardstone vault. Rune puzzle (misspelled gems → "Shine"). Animated statue fight. Targon killed by feral Kolo. Gorgons turn Kolo and Myron to stone. Lillith says under-mine may have Excalibrum. | `content/eps/53.tex` |
| 54 | Into the Darkness | Lillith aids escape from mines. KOLO SACRIFICES DAISUKE to Kalimar, disappears into darkness. Exme scans: "Kah-lee-mah". Destoning potions left behind. | `content/eps/54.tex` |
| 55 | Breakfast Cat - Origins | Flashback: young Kolo saves young Exme from boar. Present: Exme confronts Lazarus demanding help. Toni arrives. Explore dwarven crypt — fight four-armed abomination. Toni's berserker rage. Find RuneCarving manual. Epilogue: Exme runs battle simulations targeting "Lazzyrus's Place". | `content/eps/55.tex` |

### Main Campaign (eps 56-80)
...
| 63 | Golding's Bay | Written as spy report. Freyer Thistlebloom (SRA, magical) ensorcells party into slaughtering villagers in temple. | `content/eps/63.tex` |
| 64 | Anthony's Crisis | Anthony surrenders to arbiters, disgusted by massacre. Party escapes via cube. Anthony rescued by Burnie. Fake Kiros theory. | `content/eps/64.tex` |
| 65 | Police Interview | Police interview format. Kiros confirmed captured (doppelganger replaced him). Exme invisible recon. Church frames party as "Cult of Synne". Souls going missing. Anthony departs. | `content/eps/65.tex` |
| 66 | No Catchy Title | Anthony leaves (heading to Expanse). IRIS revealed (AI in Burnie's eye). Kolo/"The Butcher" left sewers, vanished. Inquisitor appears. | `content/eps/66.tex` |
| 67 | Inquisitair Jordans | Fight Inquisitor (immune to non-Excalibrum). STANRI rebuilt as tiger ("Stanri 2"). Riphard kills Inquisitor with Excalibrum pick. Tentacle mouth, Canilon tattoo. Sewer mutant goblins capture party. | `content/eps/67.tex` |
| 68 | Kill Kolo | MAJOR EPISODE. Kolo massively mutated (giant arm, wings, fungus). Kolo crushes Delilah's head. Exme stops time with cube, saves babies. Riphard strangles Kolo with whip. Burnie seals Kalimar pit with stone dagger. | `content/eps/68.tex` |
| 68a | Exme's Thoughts | Exme's emotional internal monologue. "Help me" note from Kolo. Failed attempts to save him. Myron: "This is all your fault." Exme decides to leave group. Remembers Kolo as a child. | `content/eps/68a.tex` |
| 69 | Welcome to the Shit Show | Aftermath. Exme leaves with Kolo's corpse, gives Burnie the Puzzle Die and note: "I thought I could have both of you." Kevin introduced by Buck McCraw. Visit Lazarus — Delilah in Hell, Kolo's soul missing. Burnie's parents join as babysitters. Heading to Linderdorf. Myron and Riphard secretly plot to kill Burnie. | `content/eps/69.tex` |
| 70 | The Hunt for Google Von Maccherstein | Arrive in Linderdorf (mountain city of foundries and automatons). Drunkenly search for master blacksmith Google Von Maccherstein. Myron invents "Piece of Shit" cocktail. Riphard buys a schnitzel business. Google is out exploring Varg lands. Meet assistant Burnice. | `content/eps/70.tex` |
| 71 | Martin the Paranoid Android | Written as Kevin's letter to Professor McCaw. Travel north into Varg lands. Find Martin Andleberger chained up by bearkin. Rescue him. Martin stutters (fixed by shock). Kevin substitutes gravy for Bovril. Martin has cable-hand. Lightning strikes airship. Epilogue: Exme's unsent letter to Myron. | `content/eps/71.tex` |
| 72 | Ready Keddy Go | Track gnome inventors' trail. Martin builds sled. Encounter Varg children. See giants near Varg Hold. Toboggan into battle. Fight storm giant (throws lightning). Kevin climbs on giant. Rescue gnome inventors from sack. | `content/eps/72.tex` |
| 73 | ForgeMasters | Gnomes want ancient Bright Bart Forge (not Varg weapons). Climb mountain in storm. Fight Aspect of the Storm (air elemental with lightning sword). Martin breaks down. Find forge — dwarven skeletons, forging books, rune carving tools, 5000gp trinkets. Martin makes deal with Lazarus. Myron sees Lady Haramxe. Everyone gets Excalibrum weapons (Kevin gets a stick). | `content/eps/73.tex` |
| 74 | Of Mice and Mechs | Downtime in Linderdorf. Myron visits father Jorge, meets stepmother Holly Dew (née Thistlebloom). Myron's mother joined cult destroyed by Church. Burnie seeks safe house for family. Martin is a mouse. Discover Stonecast Mech exists — challenge its owners to arena fight. | `content/eps/74.tex` |
| 75 | How to Kill Giant Robots and Influence People | Visit Lazarus's war room — cube locates seal source at Seven's Spire. Plan alliance strategy. Win 48000gp betting on themselves. Fight and destroy Stonecast Mech — Myron bisects it with Godbringer. "EMANCIPATION!" speech rallies crowd. Win the robot. Exme discovers higher cube function. Plan final assault. | `content/eps/75.tex` |
| 76 | The Play's the Thing | Send letters to allies. Printing press for revolutionary literature. Cube plugged into ghost engine for hyper-speed. Travel to Tom'ardy. Riphard keeping mannequin wife and pork children. Tom'ardy is now a socialist utopia. Lillith found on council. Perform "the greatest play ever played." Lillith agrees to infiltrate Seven's Spire. | `content/eps/76.tex` |
| 77 | Dear Dairy | Travel to New Abbergast. Lady Dab'Agast pregnant with fish king's child. Church tried to turn her against party. Recruit fish army for Hope's Rest. Fight mysterious thorny tentacle creatures and octopodes at underwater ruins — controlled farmers speak in unison to Myron. King Oceani commits army. | `content/eps/77.tex` |
| 78 | The Old Man at the Coconut Shy | Fly to Logarsk for giant robot. Plans to destroy/infiltrate Seven's Spire tower. Disguises for Festival of Light: Myron as lemon, Exme as Otoria inside meat-covered STANRI, Burnie as Papa Lazarus. Visit Lazarus about Kolo's soul — only gods can help. Myron's hilltop prayer to all gods. Festival infiltration. Mysterious old man at coconut shy knows Myron. Arrested for unlicensed entertainment. Lillith is the pastor who "arrests" them — inside the Spire. | `content/eps/78.tex` |
...
1. **Resurrection** (ep 1): Lazarus resurrects 5 dead strangers in Hell. Mission: destroy the Church, break the seal on the gods.
2. **Stone of Unthala** (eps 1-3): Retrieve communication stone from frozen ice temple. Fight TikkiTukks.
3. **Riverfall** (eps 4-9a): Exorcise Pilch, found Northern Rock bank, survive Die Hard heist. Otoria dies.
4. **Hope's Rest** (eps 10-18): Found Gary Guild, establish bank, navigate guild politics, Gary joins police. SRA dealt with.
5. **Desert & Sea** (eps 19-24): Cross Great Expanse (Spancer allies), sail from Port Averdale. Pilch dies at sea. Mark emerges.
6. **Jungle Continent** (eps 25-28): Gary sacrifices himself. Discover Tower of Ruh'Breks, gain Puzzle Die and airship. Myron and Vu Dong join.
7. **Masuda Campaign** (eps 29-48): Civil war, becoming Ronin, Lord of Lightning, castle infiltration, Hearthrust Society alliance, Hammer of the Gods retrieved, Battle of Masuda, Ruh'Breks Sensei dies. Orcano fight, Lady Hirota rescue.
8. **Book Burner Flashbacks** (eps 33-5a to 33-5d): VR time-travel. Book Burner origin stories. Reveals Pilch caused the purge. Vu Dong erased, Burnie joins.
9. **Tom'ardy Mountains** (eps 45-55): Return to dwarven homeland. Discover slave economy. Search for Excalibrum in deep mines. Kolo goes feral, turns to stone with Myron. Targon killed. Toni joins. Lillith found. Exme plots against Lazarus.
10. **Kolo's Descent & Death** (eps 54-68): Kolo sacrifices Daisuke to Kalimar, disappears. Party destones allies, finds Excalibrum (ep 57). Delilah gives birth to twins (ep 58). Anthony joins and departs (eps 56-66). Inquisitor fought — immune to non-Excalibrum (ep 67). STANRI rebuilt as tiger. Kolo found massively mutated in sewers. Kolo kills Delilah; Riphard kills Kolo (ep 68). Exme leaves group.
11. **The Shit Show** (eps 69-70): Kevin joins. Visit Lazarus — Delilah in Hell, Kolo's soul missing. Travel to Linderdorf seeking blacksmith for Excalibrum weapons.
12. **Linderdorf & The Forge** (eps 70-75): Hunt for Google Von Maccherstein. Find Martin beaten by bearkin in Varg (ep 71). Rescue gnome inventors from giants (ep 72). Discover Bright Bart Forge — fight Aspect of the Storm (ep 73). Excalibrum weapons forged. Myron reunites with father. Win giant Stonecast Mech in arena fight (ep 75). Exme discovers cube can locate seal source — it's at Seven's Spire. Martin makes deal with Lazarus.
