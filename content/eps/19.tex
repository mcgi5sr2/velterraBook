...
\begin{center}
\includegraphics[width=110mm]{./content/img/reddit/gamrcApothecary.jpg}\\
\textit{G-AMRC Rooftop Apothecary Is Now Open}
\end{center}

\begin{center}
\includegraphics[width=100mm]{./content/img/reddit/exmelabSelfie.jpg}\\
\textit{First day selfie yo!!1! \#exmelab}
\end{center}
