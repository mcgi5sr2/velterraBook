...
\begin{center}
\includegraphics[width=70mm]{./content/img/reddit/grumpyStanri.png}\\
\textit{Grumpy Stanri --- Your fearless leader}
\end{center}

\begin{center}
\includegraphics[width=70mm]{./content/img/reddit/tanIata.png}\\
\textit{Tan-Iata --- The one that knocks in the night}
\end{center}

\begin{center}
\includegraphics[width=70mm]{./content/img/reddit/devIeda.jpg}\\
\textit{Dev'Ieda Stanri --- Small Trouble}
\end{center}

\begin{center}
\includegraphics[width=70mm]{./content/img/reddit/kriIgo.jpg}\\
\textit{Kri-Igo Stanri --- First Born}
\end{center}
