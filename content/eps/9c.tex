...
\begin{center}
\includegraphics[width=70mm]{./content/img/reddit/deadlySeaSnake.jpg}\\
\textit{Kolos Story --- DeadlySeaSnake}
\end{center}

\begin{center}
\includegraphics[width=70mm]{./content/img/reddit/treeOctopus.jpg}\\
\textit{Kolos Story --- Tree Octopodicus}
\end{center}

\begin{center}
\includegraphics[width=70mm]{./content/img/reddit/deathHippo.jpg}\\
\textit{Kolos Story --- Forest Death Hippo}
\end{center}

\begin{center}
\includegraphics[width=70mm]{./content/img/reddit/daneOSaurus.jpg}\\
\textit{Rare Sighting of One Dane'O'Saurus}
\end{center}
